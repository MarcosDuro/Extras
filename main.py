...
def hidden_card_number2(card_number):
    return card_number[:-6] + "xx78xx"    
    
def hidden_card_number3(card_number):
    hidden_digits = card_number[:7] + "x" + card_number[8:10] + "xx" + card_number[10:12] + "x" + card_number[13:]
...
- - - - - - - - - - - - - - - - - - - -- - - - - - - - - - -
ⓘ 𝗘𝗫𝗧𝗥𝗔 𝟏: <code>{hidden_card_number(cc)} {mes}/{ano}</code>
- - - - - - - - - - - - - - - - - - - -- - - - - - - - - - -
ⓘ 𝗘𝗫𝗧𝗥𝗔 𝟮: <code>{hidden_card_number2(cc)} {mes}/ {ano}</code>
- - - - - - - - - - - - - - - - - - - -- - - - - - - - - - -
ⓘ 𝗘𝗫𝗧𝗥𝗔 𝟯: <code>{hidden_card_number3(cc)} {mes}/ {ano}</code>
- - - - - - - - - - - - - - - - - - - -- - - - - - - - - - -
⤿𝗕𝗜𝗡: <code>{cc[:6]}</code>
